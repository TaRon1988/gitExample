...
public class RandomFile {
	public static void main(String[] args) {
		...
		try {//r:읽기전용, w쓰기전용, rw: 읽기, 쓰기
			...
			file.write("HTML".getBytes());//인덱스 8번 위치에서 기존 내용을 덮어쓰게 된다.
			System.out.println(file.length());//문자 길이 확인(한글은 3바이트 길이값을 가짐)
